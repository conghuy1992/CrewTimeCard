...
public class SpinnerAdapter extends ArrayAdapter<MenuDto> {

    public SpinnerAdapter(Context context, int resource, List<MenuDto> objects) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.spinner_textview_single_devider, parent, false);
